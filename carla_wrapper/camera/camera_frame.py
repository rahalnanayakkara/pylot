...
import carla_wrapper.utils.detection_utils
import carla_wrapper.utils.carla_wrapper_utils
from carla_wrapper.camera.sensor_setup import CameraSetup
from carla_wrapper.utils.carla_wrapper_utils import Vector2D
...
class CameraFrame(object):
    ...
    def annotate_with_bounding_boxes(self,
                                     ...
                                     detected_obstacles,
                                     transform=None,
                                     bbox_color_map=carla_wrapper.utils.detection_utils.PYLOT_BBOX_COLOR_MAP):
        carla_wrapper.utils.carla_wrapper_utils.add_timestamp(self.frame, timestamp)
    ...
    def draw_point(self, point: Vector2D, color, r: float = 3):
        ...
        Args:
            point (:py:class:`~carla_wrapper.utils.carla_wrapper_utils.Vector2D`): Where to draw the point.
    ...
    def draw_text(self,
        ...
        Args:
            point (:py:class:`~carla_wrapper.utils.carla_wrapper_utils.Vector2D`): Where to draw the text.
