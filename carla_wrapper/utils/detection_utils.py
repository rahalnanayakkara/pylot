...
class BoundingBox3D(object):
    ...
    Args:
        transform (:py:class:`~carla_wrapper.utils.carla_wrapper_utils.Transform`): Transform of the
            bounding box (rotation is (0, 0, 0)).
        extent (:py:class:`~carla_wrapper.utils.carla_wrapper_utils.Vector3D`): The extent of the bounding
            box.
    ...
    def visualize(self, world, actor_transform, time_between_frames=100):
        ...
        Args:
            world: The simulator world instance to visualize the bounding
                box on.
            actor_transform (:py:class:`~carla_wrapper.utils.carla_wrapper_utils.Transform`): The current
    ...
    def to_camera_view(self, obstacle_transform: carla_wrapper.utils.carla_wrapper_utils.Transform,
        ...
        Args:
            obstacle_transform (:py:class:`~carla_wrapper.utils.carla_wrapper_utils.Transform`): The
...
def get_bounding_box_in_camera_view(bb_coordinates, image_width, image_height):
    ...
    Args:
        bb_coordinates: 8 :py:class:`~carla_wrapper.utils.carla_wrapper_utils.Location` coordinates of
