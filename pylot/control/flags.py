...
flags.DEFINE_string('remote_control_server_local', '0.0.0.0', 'Remote server to fetch control instructions')
flags.DEFINE_integer('remote_control_port_local', 5010, 'Remote server to fetch control instructions')
flags.DEFINE_string('remote_control_server_cloud', '0.0.0.0', 'Remote server to fetch control instructions')
