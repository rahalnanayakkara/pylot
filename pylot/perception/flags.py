...
flags.DEFINE_string('remote_tracking_server_local', '172.17.0.1', 'Remote server to fetch tracking information')
flags.DEFINE_integer('remote_tracking_port_local', 5020, 'Remote server to fetch tracking information')
flags.DEFINE_string('remote_tracking_server_cloud', '54.183.253.75', 'Remote server to fetch tracking information')
